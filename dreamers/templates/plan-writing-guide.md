...
- **Test command:** the command from `AGENTS.md`, `CODEX.md`, or `.github/copilot-instructions.md`
- **Type-check command:** the command from `AGENTS.md`, `CODEX.md`, or `.github/copilot-instructions.md`
