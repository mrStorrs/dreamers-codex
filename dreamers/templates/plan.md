...
- **Test command:** [command from `AGENTS.md`, `CODEX.md`, or `.github/copilot-instructions.md`]
- **Type-check command:** [command from `AGENTS.md`, `CODEX.md`, or `.github/copilot-instructions.md`]
