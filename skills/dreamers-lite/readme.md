...
```mermaid
flowchart TD
    Start(["dreamers-lite input"]) --> ModeCheck{"Input<br/>type?"}
    ...
    GrillChoice -->|Yes| Grill["Phase 1A Grill<br/>one question-tool ask at a time"]
    ...
    Gate -->|Bug| Fix
    UserTest -->|No| Docs
    Gate -->|Approved| Docs["dreamers-docs --branch"]
    Docs --> Commit["Commit"]
