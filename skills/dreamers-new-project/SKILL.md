...
description: "Bootstrap a brand new project from scratch: discovery questions, project brief, shell plans. Use when the user asks for dreamers-new-project, new project, bootstrap a project, start a new project."
---
