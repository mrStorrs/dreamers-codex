...
description: "Deep research with phased workflow: scoping, parallel sub-topic research, synthesis, final report. Use when the user asks for dreamers-research, research, deep research, investigate, find out about."
---
...
After Sage returns, present the sub-topics to the user and ask the user with multi-select enabled, one option per sub-topic plus a `"Cancel research"` option:
