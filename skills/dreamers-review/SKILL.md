...
- When standalone, call `update_plan` with a todo list for Step 1 / Step 2. When invoked by an outer delivery skill, complete these steps under its existing plan.
