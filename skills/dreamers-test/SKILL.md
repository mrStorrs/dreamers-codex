---
name: dreamers-test
description: "Standalone Probe review (test coverage audit). Read-only — returns structured findings on AC coverage, layer audit, edge cases, regression risks. No auto-fix. Use when the user asks for dreamers-test, test coverage audit, audit tests, check test gaps."
---
...
```
role prompt: `dreamers/agents/probe.md`
